...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9B53A608AF
	for <lists+xdp-newbies@lfdr.de>; Fri,  5 Jul 2019 17:05:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726851AbfGEPFW (ORCPT <rfc822;lists+xdp-newbies@lfdr.de>);
        Fri, 5 Jul 2019 11:05:22 -0400
Received: from mail-lj1-f196.google.com ([209.85.208.196]:43587 "EHLO
        mail-lj1-f196.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726593AbfGEPFP (ORCPT
        <rfc822;xdp-newbies@vger.kernel.org>); Fri, 5 Jul 2019 11:05:15 -0400
Received: by mail-lj1-f196.google.com with SMTP id 16so9540218ljv.10
        for <xdp-newbies@vger.kernel.org>; Fri, 05 Jul 2019 08:05:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=YGpf6fNChIBLFWjvOEHH3tp/jNf+cu9bYue663iprcw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=YGpf6fNChIBLFWjvOEHH3tp/jNf+cu9bYue663iprcw=;
        b=
X-Gm-Message-State: APjAAAXoTBOxcZrDkDzgz7OoONbjHCEda5pZFML92xwk77TD8++tLA/x
        rhYdVVoqEXGcQ75SG9Hbuw+KDg==
X-Google-Smtp-Source: APXvYqyiipUt3Sn7pvClyKm6VCZgq5/7grFqkHEurexhZeAvO+JX1samk9dmSSGSL/fIkpDBa60ybw==
X-Received: by 2002:a2e:8744:: with SMTP id q4mr2397633ljj.77.1562339111847;
        Fri, 05 Jul 2019 08:05:11 -0700 (PDT)
Received: from localhost.localdomain (59-201-94-178.pool.ukrtel.net. [178.94.201.59])
        by smtp.gmail.com with ESMTPSA id y4sm1433660lfc.56.2019.07.05.08.05.10
...
Subject: [PATCH v8 net-next 5/5] net: ethernet: ti: cpsw: add XDP support
Date:   Fri,  5 Jul 2019 18:05:02 +0300
Message-Id: <20190705150502.6600-6-ivan.khoronzhuk@linaro.org>

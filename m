...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E9D765E8033
	for <lists+xdp-newbies@lfdr.de>; Fri, 23 Sep 2022 18:55:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231991AbiIWQzg (ORCPT <rfc822;lists+xdp-newbies@lfdr.de>);
        Fri, 23 Sep 2022 12:55:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51814 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232457AbiIWQz2 (ORCPT
        <rfc822;xdp-newbies@vger.kernel.org>);
        Fri, 23 Sep 2022 12:55:28 -0400
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com [170.10.129.124])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 59F84B14F6
        for <xdp-newbies@vger.kernel.org>; Fri, 23 Sep 2022 09:55:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1663952126;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=1KKpI8bO7lDEDL+XPQvHWnpkn7vw6Ua/JL348GkDP2U=;
        b=hEnbH5/GKFOj4OYSmy7k6DmRNmuxCoTUgSe+LVLIHO8xIbIk4dPNOw5Ze196gWzvVMK45L
        ZHiHGqTYvgxV/7neOuBNswaQfSKIJW7rKERvnZO+rqwdg84Ff0VJUNiBgTIqeBV7+BJzQL
        7uvGBnWQm1Axx7pqSD2y1/BAn1vrCMI=
Received: from mail-ej1-f70.google.com (mail-ej1-f70.google.com
 [209.85.218.70]) by relay.mimecast.com with ESMTP with STARTTLS
 (version=TLSv1.3, cipher=TLS_AES_128_GCM_SHA256) id
 us-mta-633-Kk4pRqkVNxSQPcphLg4aGw-1; Fri, 23 Sep 2022 12:55:22 -0400
X-MC-Unique: Kk4pRqkVNxSQPcphLg4aGw-1
Received: by mail-ej1-f70.google.com with SMTP id dt13-20020a170907728d00b007825956d979so378173ejc.15
        for <xdp-newbies@vger.kernel.org>; Fri, 23 Sep 2022 09:55:21 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1KKpI8bO7lDEDL+XPQvHWnpkn7vw6Ua/JL348GkDP2U=;
        b=
X-Gm-Message-State: ACrzQf2VMAgE7Y7HsH1X8BtE3EE8jqcdsw9O6Ltw0gw7gjwP8NszQdV1
        jUedCuKGstWMs9au8K9gg/lM43i4MzUzjVQZipSRn2L0OxV0L/xkFQgD6SObinjkx2Aor0UxPBy
        /kt6gu+1hu6e8Y+pA/Jgv98w=
X-Received: by 2002:a17:907:2c77:b0:77c:59aa:c011 with SMTP id ib23-20020a1709072c7700b0077c59aac011mr7967378ejc.724.1663952120960;
        Fri, 23 Sep 2022 09:55:20 -0700 (PDT)
X-Google-Smtp-Source: AMsMyM6ttfQoZ/oNqXtDFfg4X1M/CDy+8SJx658kIaJllAsSyvfGGo9RmaJT+RzzBeD+5kILRBaE1Q==
X-Received: by 2002:a17:907:2c77:b0:77c:59aa:c011 with SMTP id ib23-20020a1709072c7700b0077c59aac011mr7967361ejc.724.1663952120598;
        Fri, 23 Sep 2022 09:55:20 -0700 (PDT)
Received: from [192.168.41.81] (83-90-141-187-cable.dk.customer.tdc.net. [83.90.141.187])
        by smtp.gmail.com with ESMTPSA id eg37-20020a05640228a500b00456cbd8c65bsm1102688edb.6.2022.09.23.09.55.18
        (version=TLS1_3 cipher=TLS_AES_128_GCM_SHA256 bits=128/128);
        Fri, 23 Sep 2022 09:55:19 -0700 (PDT)
From:   Jesper Dangaard Brouer <jbrouer@redhat.com>
X-Google-Original-From: Jesper Dangaard Brouer <brouer@redhat.com>
Message-ID: <4400b817-582a-842a-282b-4dd6d8a22f11@redhat.com>
Date:   Fri, 23 Sep 2022 18:55:17 +0200
MIME-Version: 1.0
...
To:     Adam Smith <hrotsvit@gmail.com>,
...
References: <CADx6jH51gFXRvp2H76eePrz2oTw5-Av6nV4-N+CVVcgDKAuL2A@mail.gmail.com>
 ...
 <CADx6jH5iNLh7_zPhynBS4qwvvYj4DugLj5gBDdutUqX0UBK78g@mail.gmail.com>
In-Reply-To: <CADx6jH5iNLh7_zPhynBS4qwvvYj4DugLj5gBDdutUqX0UBK78g@mail.gmail.com>

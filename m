...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 107AF10760F
	for <lists+xdp-newbies@lfdr.de>; Fri, 22 Nov 2019 17:58:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726704AbfKVQ6B (ORCPT <rfc822;lists+xdp-newbies@lfdr.de>);
        Fri, 22 Nov 2019 11:58:01 -0500
Received: from us-smtp-delivery-1.mimecast.com ([207.211.31.120]:59212 "EHLO
        us-smtp-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL) by vger.kernel.org
        with ESMTP id S1726633AbfKVQ6B (ORCPT
        <rfc822;xdp-newbies@vger.kernel.org>);
        Fri, 22 Nov 2019 11:58:01 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1574441880;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:content-type:content-type:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=AvsGUy/REFNRPCWSB+iNYRuyQK+ahhfUg1D/UZDO1GU=;
        b=IKdNVjcHzdYV5i6XYW0EJaLI0auIi8wu4zBdGIYu61vhPUbrMuMbpQp/9VFrTUWhP6L9PU
        SJRjNkbwptWuBDGrKCqmXkKNd+KLjvxrqphzavJpZqYxzkwPqYickVdMprUtm5htgi4Jlw
        nCwqrtHNEKvLUBuZX/XRMfwIGxIu5hU=

...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id F1736BE8FA
	for <lists+xdp-newbies@lfdr.de>; Thu, 26 Sep 2019 01:34:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728902AbfIYXeK (ORCPT <rfc822;lists+xdp-newbies@lfdr.de>);
        Wed, 25 Sep 2019 19:34:10 -0400
Received: from mail-qt1-f173.google.com ([209.85.160.173]:37730 "EHLO
        mail-qt1-f173.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728740AbfIYXeK (ORCPT
        <rfc822;xdp-newbies@vger.kernel.org>);
        Wed, 25 Sep 2019 19:34:10 -0400
Received: by mail-qt1-f173.google.com with SMTP id l3so634341qtr.4
        for <xdp-newbies@vger.kernel.org>; Wed, 25 Sep 2019 16:34:09 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc:content-transfer-encoding;
        bh=CXPwEQnflqCt6BCJGFJpV9YXQ3VghaMYRb05LjJ1z2E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=CXPwEQnflqCt6BCJGFJpV9YXQ3VghaMYRb05LjJ1z2E=;
        b=
X-Gm-Message-State: APjAAAWOgOPY0y4Mjfn9qeliNqNUn7nnHvAEMIAUfiuvWPsi6zF64siM
        gZ9WyHBKEIgrrkuXYaJ8gVDUHEjioMrygh9EMaY6zvLt
X-Google-Smtp-Source: APXvYqy+MDylvZ2l2k+9ogE+TDVQVZDhA2j5kQt4x7pq9PGKRKLS+PrwJ7ZyGsYiWlHNPDyZh0oJLV+jr+G1atkw9Zo=
X-Received: by 2002:ac8:2cdc:: with SMTP id 28mr1039356qtx.212.1569454449247;
 Wed, 25 Sep 2019 16:34:09 -0700 (PDT)
MIME-Version: 1.0
...
In-Reply-To: <565AE8A9-8A0D-4582-A3C5-D317F4DA0C9F@redhat.com>
From:   William Tu <u9012063@gmail.com>
Date:   Wed, 25 Sep 2019 16:33:33 -0700
Message-ID: <CALDO+SbC-64-78Fxv4u3p8RHG9n9jqcEHE3rRK5QjqF_KH+bmQ@mail.gmail.com>
...
> >> is copying the memory to the egress interface it=E2=80=99s mmaped memo=
ry.
...
> > <u9012063@gmail.com>; Bj=C3=B6rn T=C3=B6pel <bjorn.topel@intel.com>; Ma=
rek
> > Z=C3=A1vodsk=C3=BD <marek.zavodsky@pantheon.tech>; Jesper Dangaard Brou=
er
...
> >
> > Currently, OVS uses the mmaped memory directly, however on egress, it
> > is copying the memory to the egress interface it=E2=80=99s mmaped memor=
y.
> > Currently, OVS uses an AF_XDP memory pool per interface, so a further
> > optimization could be to use a global memory pool so this extra copy
> > is not needed.

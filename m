...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9C618A5A0D
	for <lists+xdp-newbies@lfdr.de>; Mon,  2 Sep 2019 17:03:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731792AbfIBPB5 (ORCPT <rfc822;lists+xdp-newbies@lfdr.de>);
        Mon, 2 Sep 2019 11:01:57 -0400
Received: from mx1.redhat.com ([209.132.183.28]:35238 "EHLO mx1.redhat.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731783AbfIBPB5 (ORCPT <rfc822;xdp-newbies@vger.kernel.org>);
        Mon, 2 Sep 2019 11:01:57 -0400
Received: from mail-qt1-f197.google.com (mail-qt1-f197.google.com [209.85.160.197])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mx1.redhat.com (Postfix) with ESMTPS id 1DB443D962
        for <xdp-newbies@vger.kernel.org>; Mon,  2 Sep 2019 15:01:57 +0000 (UTC)
Received: by mail-qt1-f197.google.com with SMTP id e22so15942455qtp.9
        for <xdp-newbies@vger.kernel.org>; Mon, 02 Sep 2019 08:01:57 -0700 (PDT)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:in-reply-to;
        bh=3eUULgrjIJg0a0dnW4SKY8dVu/LzudzFut/uYLoCkM0=;
        b=
X-Gm-Message-State: APjAAAV/ABl/WNtEVIGWwKqmLIVMvhPTJlOT0VRkQYFBCsU55/TximMr
        gJ+2GnyWjL5rVgzefQWbHNO+wIi3GvAbzmBpzE7cn+bZmFz22YWaIijYc+wU1GH7XAUXMX+GJjp
        2BM/F5wWzDhRMb8UILRG+m+M=
X-Received: by 2002:ac8:750e:: with SMTP id u14mr28909655qtq.282.1567436516413;
